...
public class BoutonAmeliore extends JButton implements MouseListener {
	/*
	 * fields
	 */
	private String name ;
	 ...
	 * methods
	 */
	public BoutonAmeliore(String str) {
		super(str);
		this.name = str ;
		try {
	...
	public void paintComponent(Graphics g) {
		...
		// objet permettant de connaitre les proprietes d une police dont ala taille
		FontMetrics fm = g2d.getFontMetrics();
		// hauteur de al police d ecriture 
		int height = fm.getHeight();
		//longueur totale de la chaine passee en parametre 
		int width = fm.stringWidth(this.name) ; 
		
		g2d.drawString(this.name, this.getWidth() / 2 - (width/ 2 /4), (this.getHeight() / 2) + (height /4 ) );
